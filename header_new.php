...
<html lang="en">
  ...
  <body>
    ...
    <div class="navbar navbar-inverse navbar-fixed-top customNav">
      ...
      <img src="./assets/img/cario.png" class="brand" style="height: 30px; ">
  ...
  <a>  new user ?</a></br>
            <input type="text" id="input user name" placeholder="User Name">
            <input type="password" id="inputPassword" placeholder="Password">
	         <button type="submit" class="btn-mini" >Sign in</button>
